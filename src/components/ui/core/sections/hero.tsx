...
Profile
        ...
        <p className=' text-accent-foreground     text-xl  tracking-tight font-poppin '>By : Team Perintis Code</p>
      </header>
          <Image src={'/assets/hero.jpg'} quality={100} priority  fill  alt='hero-image-cover' className='   md:inline object-center object-cover z-0 transform absolute w-full h-full' />
      {/* Hello World */}
